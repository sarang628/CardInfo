...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull ImageView rootView, @NonNull ImageView ivRestaurant) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    ImageView ivRestaurant = (ImageView) rootView;

    return new ItemImageBinding((ImageView) rootView, ivRestaurant);
  }
}
