 ...
 */
public abstract class Hilt_RestaurantInfoCardFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RestaurantInfoCardFragment() {
    super();
  }

  Hilt_RestaurantInfoCardFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RestaurantInfoCardFragment_GeneratedInjector) this.generatedComponent()).injectRestaurantInfoCardFragment(UnsafeCasts.<RestaurantInfoCardFragment>unsafeCast(this));
    }
  }
